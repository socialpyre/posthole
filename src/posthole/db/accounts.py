...
# IG uses BUSINESS/CREATOR/PERSONAL; TikTok uses BUSINESS_ACCOUNT/CREATOR_ACCOUNT/
# PERSONAL_ACCOUNT. Kept as plain ``str`` rather than a Literal so each
# platform's enums coexist.
AccountType = str
